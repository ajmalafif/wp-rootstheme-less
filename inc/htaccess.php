...
if (stristr($_SERVER['SERVER_SOFTWARE'], 'apache') || stristr($_SERVER['SERVER_SOFTWARE'], 'litespeed') !== false) {
  ...
  // rewrite /wp/afif/wp-content/themes/roots/css/ to /css/
  // rewrite wp/afif/wp-content/themes/roots/js/  to /js/
  // rewrite wp/afif/wp-content/themes/roots/img/ to /js/
  // rewrite wp/afif/wp-content/plugins/ to /plugins/
